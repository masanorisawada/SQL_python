...
space = np.array([])
name_x = input("調べたい場所を入力してください(高尾山、鳥取砂丘、羽田空港、築地本願寺、東京ドイツ村から選んでください)")
space_x = da.get_spots_by_space_name(name_x)
space = np.append(space,space_x)
name_y = input("調べたい場所を入力してください(高尾山、鳥取砂丘、羽田空港、築地本願寺、東京ドイツ村から選んでください)")
space_y = da.get_spots_by_space_name(name_y)
space = np.append(space,space_y)
name_z = input("調べたい場所を入力してください(高尾山、鳥取砂丘、羽田空港、築地本願寺、東京ドイツ村から選んでください)")
