...
class Genetic_Algorithm():
    ...
    def __init__(self, point_size, points, name):
        ...
        for ind in range(self.POPULATION_SIZE):
            ...
            for i in range(self.POINTS_SIZE):
                ...
                if i == self.POINTS_SIZE - 1:
                    ...
                    (x1, y1) = points[route[i+1]]
        name_ = []
        print('道順は',city_name[self.POPULATION_SIZE-1])
        for i in city_name[self.POPULATION_SIZE-1]:
            name_.append(self.NAME[i])
        print('道順は',name_)
        # print(city_name[self.POPULATION_SIZE-1])
        print('最短距離は',dist_list[self.POPULATION_SIZE-1])
        # for i in city_name[self.POPULATION_SIZE-1]:
        #     print()
